...
/* harmony import */ var _services_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/service */ "./src/js/services/service.js");
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', e => {
      ...
      (0,_services_service__WEBPACK_IMPORTED_MODULE_3__.postData)('http://localhost:3000/requests', json).then(data => {
        console.log(data);
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_2__.openModal)('.modal', modalTimerId);
    ...
    setTimeout(() => {
      ...
      (0,_modal__WEBPACK_IMPORTED_MODULE_2__.closeModal)('.modal');
    }, 4000);
  }
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2024-12-01T09:00:00');
